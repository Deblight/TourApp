...
public static class BookingServiceDependencyInjection
{
  ...
  public static IServiceCollection AddDatabaseConnection(this IServiceCollection @this, string uri, string username, string password)
  {
    ...
    @this.AddRabbitMQRepository(uri, username, password);
